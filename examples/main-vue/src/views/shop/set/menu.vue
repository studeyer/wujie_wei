<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="data" size="small" style="width: 100%">
      ...
      <el-table-column
        v-if="checkPermission(['admin', 'YXSYSTEMGROUPDATA_ALL', 'YXSYSTEMGROUPDATA_EDIT', 'YXSYSTEMGROUPDATA_DELETE'])"
        label="操作"
        width="150px"
        align="center"
      >
        <template slot-scope="scope">
          <el-button
            v-permission="['admin', 'YXSYSTEMGROUPDATA_ALL', 'YXSYSTEMGROUPDATA_EDIT']"
            size="mini"
            type="primary"
            icon="el-icon-edit"
